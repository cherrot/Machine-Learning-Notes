...
\begin{figure}[!tbh]
\begin{centering}
\includegraphics[width=0.8\paperwidth]{\string"7.4.Advanced optimization\string".png}
\par\end{centering}
...
\begin{figure}[!tbh]
\begin{centering}
\includegraphics[width=0.8\paperwidth]{\string"8.2.Neurons and brain\string".png}
\par\end{centering}
...
\begin{figure}[!tbh]
\begin{centering}
\includegraphics[width=0.8\paperwidth]{\string"8.3.Neural Network2\string".png}
\par\end{centering}
...
\includegraphics[width=0.7\paperwidth]{8\lyxdot 6\lyxdot examples2}
